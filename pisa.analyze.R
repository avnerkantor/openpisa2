...
updateCheckboxGroupInput(session, "show_vars", "", colnames(analyzeData), selected = c("Country", "Subject", "variable", "r.squared", "p.value", "n"), inline=TRUE)
